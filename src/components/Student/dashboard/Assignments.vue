  ...
  <v-card elevation="2" class="assignmentTable">
    ...
    <div class="assignMain">
      <div class="assignButtons">
        <v-btn text @click="changeTabTo('new')" :color="newTab ? 'primary' : ''"
          ><span>New</span>
        ...
        <v-btn
          text
          @click="changeTabTo('unsubmitted')"
          :color="unsubmitted ? 'primary' : ''"
          ><span>Unsubmitted</span>
          <v-avatar color="#FF6D6D" size="25" class="white--text">3</v-avatar>
        </v-btn>
      </div>
      <div class="assignmentNew">
        <v-data-table
          hide-default-footer
          :headers="headers"
          :items="newTab ? assignmentsSubmitted : assignmentUnsubmitted"
          :items-per-page="5"
