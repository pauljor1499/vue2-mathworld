...
export default {
    ...
    methods: {
        addNewEducation() {
            ...
            ProfilePageService.prototype.addNewEducation(this.new_item);
            this.$emit(
                "SnackbarSuccess",
                "Education details successfully added"
            );
            this.resetAllFields();
        },
    ...
    computed: {
        schoolErrors() {
            ...
            !this.$v.input_item.school.required &&
        ...
        start_yearErrors() {
            ...
            if (
                this.input_item.start_year > this.input_item.end_year ||
                this.input_item.start_year == this.input_item.end_year
            ) {
            ...
            !this.$v.input_item.start_year.required &&
        ...
        end_yearErrors() {
            ...
            !this.$v.input_item.end_year.required &&
